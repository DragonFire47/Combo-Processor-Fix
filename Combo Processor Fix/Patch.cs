...
namespace Combo_Processor_Fix
{
    ...
    class PowerPatch
    {
        ...
        {
            if (Mod.Enabled && __instance.CPUClass == ECPUClass.COMBO && (__instance.ShipStats == null || __instance.ShipStats.Ship == null || __instance.ShipStats.Ship.WarpChargeStage != EWarpChargeStage.E_WCS_PREPPING))
            {
    ...
    class FunctionPatch
    {
        ...
        {
            if (Mod.Enabled && __instance.CPUClass == ECPUClass.COMBO && (inStats.Ship == null || inStats.Ship.WarpChargeStage != EWarpChargeStage.E_WCS_PREPPING))
            {
    ...
    class StatLinePatchJP
    {
        ...
        {
            if (Mod.Enabled && __instance.CPUClass == ECPUClass.COMBO && __instance.ShipStats != null && __instance.ShipStats.Ship != null && __instance.ShipStats.Ship.WarpChargeStage != EWarpChargeStage.E_WCS_PREPPING && !__instance.ShipStats.isPreview && !__instance.InCargoSlot())
            {
                //JP portion
